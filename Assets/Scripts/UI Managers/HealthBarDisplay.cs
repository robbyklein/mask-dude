...
public class HealthBarDisplay : MonoBehaviour {
  ...
  private void handleGrayscaleChange(bool isGrayscale) {
    if (isGrayscale) {
      healthBarEl.AddToClassList("health-bar--grayscale");
    } else {
      healthBarEl.RemoveFromClassList("health-bar--grayscale");
    }
  }
}